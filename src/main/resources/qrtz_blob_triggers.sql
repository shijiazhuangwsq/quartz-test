...
Source Server         : 60.9.4.11
Source Server Version : 50562
Source Host           : 60.9.4.11:3306
Source Database       : fxyb-common

Target Server Type    : MYSQL
Target Server Version : 50562
File Encoding         : 65001

Date: 2019-12-19 09:25:59
*/
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存储 Cron Trigger，包括 Cron表达式和时区信息 ';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存储少量的有关 Scheduler 的状态信息，和别的 Scheduler实例(假如是用于一个集群中) ';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='存储SimpleTrigger，在配置文件中做如下配置，即可在qrtz_simple_triggers生成记录：';
...
CREATE TABLE `schedule_job` (
  ...
  PRIMARY KEY (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='定时任务';
...
CREATE TABLE `schedule_job_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `job_id` (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19245 DEFAULT CHARSET=utf8 COMMENT='定时任务日志';
